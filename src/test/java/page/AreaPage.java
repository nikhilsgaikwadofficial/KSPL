...
public class AreaPage extends BasePage {
        ...
        public By masterMenu = By.xpath("//i[contains(@class,'fa-database')]");
        public By areaMenu = By.xpath("//i[contains(@class,'fa-map-marked-alt')]");
        public By addAreaLink = By.xpath("(//i[contains(@class,'fa-edit')])[1]");
